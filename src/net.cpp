...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "1CRedit " + FormatFullVersion();
...
//    {"1credittools.com", "testnet-seed.1credittools.com"},
//    {"weminemnc.com", "testnet-seed.weminemnc.com"},
    {"carpenter-farms.us", "1credit.carpenter-farms.us"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. 1CRedit is probably already running."), addrBind.ToString().c_str());
        else
